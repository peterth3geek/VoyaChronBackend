...
class UserCharactersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_character" do
    assert_difference('UserCharacter.count') do
      post user_characters_url, params: { user_character: { character_id: @user_character.character_id, user_id: @user_character.user_id } }, as: :json
    end
  ...
  test "should update user_character" do
    patch user_character_url(@user_character), params: { user_character: { character_id: @user_character.character_id, user_id: @user_character.user_id } }, as: :json
    assert_response 200
  end
